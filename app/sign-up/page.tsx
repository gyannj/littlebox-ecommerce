    ...
    <div className='flex flex-col bg-dark-1 justify-center items-center text-textColor py-24'>
        ...
        <div className='flex flex-col gap-6 items-center'>
            ...
            <div className='flex flex-col gap-2'>
                ...
                <input type="text" placeholder='Username' className={placeholderStyle} />
            </div>     
            ...
            <div className='flex flex-col gap-2'>
                ...
                <input type="email" placeholder='Email ID' className={placeholderStyle} />
            </div>     
            ...
            <div className='flex flex-col gap-2'>
                ...
                <input type="tel" placeholder='Mobile Number' className={placeholderStyle} />
            </div>     
            ...
            <div className='flex flex-col gap-2'>
                ...
                <input type="text" placeholder='Address' className={placeholderStyle} />
            </div>     
