  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen text-textColor gap-32">
      ...
      <div className="flex flex-col gap-2 items-center justify-center">
        <div className="font-black text-purpleText text-9xl">404</div>
        <div className="font-bold text-4xl">Page Not Found</div>
      </div>
      <div className="flex flex-row bg-dark-3 justify-center items-center py-3 px-4 size-fit rounded-lg hover:cursor-pointer hover:bg-slate-700">
