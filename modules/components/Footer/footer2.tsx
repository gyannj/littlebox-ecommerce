  ...
  return (
    <footer className="flex flex-col bg-dark-2 text-textColor items-center p-6">
      ...
      <div className="flex flex-row justify-between gap-24 mt-6">
        ...
        <div className="flex flex-col gap-2">
          <h1 className="text-xl font-semibold text-purpleText">VISIT US</h1>
          <p className="w-64">
            NIT Silchar, NIT Silchar Road, Fakirtila, Silchar, Assam, India
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <h1 className="text-xl font-semibold text-purpleText">LEARN</h1>
          <p>About Us</p>
          <p>Developers</p>
          <p>FAQ</p>
        </div>
        <div className="flex flex-col gap-2">
          <h1 className="text-xl font-semibold text-purpleText">
            LET'S TALK SHOP
          </h1>
        ...
        <div className="flex flex-col gap-4">
          <p>
            Join 1000+ other know-what's-good-for-'em book lovers who already
